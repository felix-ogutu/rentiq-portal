...
import { Receipt, Search, ChevronLeft, ChevronRight, CheckCircle, Clock, AlertCircle } from 'lucide-react';
import { Button } from '../ui/button';
import { Input } from '../ui/input';
import { Card, CardContent } from '../ui/card';

interface CaretakerPaymentsViewProps {
  payments: Payment[];
}

export function CaretakerPaymentsView({ payments }: CaretakerPaymentsViewProps) {
    ...
    <div className="space-y-6 p-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">View all tenant payment transactions</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="Search by tenant, unit, or type..."
              value={searchQuery}
              ...
              {paginatedPayments.map((payment, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <p className="font-semibold text-gray-900">{payment.tenantName || 'N/A'}</p>
                    </td>
                    <td className="py-4 px-6">
                      <p className="text-gray-700">{payment.unitNumber || 'N/A'}</p>
                    </td>
                    <td className="py-4 px-6">
